...
walk = "./acc_gps/Accelerometer.csv"

df = pd.read_csv(url)
testi = pd.read_csv(walk)
...
# # Draw the map
# folium.PolyLine(df[["Latitude (°)", "Longitude (°)"]], color="blue", weight=3.5, opacity=1).add_to(
#     map
# )
...
temp = hf.filterWithButterLow(testi, "z", 0.5)
print("askelmäärä: ", hf.getStepsFromFilteredData(temp))

# Tulosta askeleet
# st.write(
#     "Askelmäärä: ",
#     hf.getStepsFromFilteredData(temp),
#     "\n(Scipy kirjaston butter(lowpass) suodatus)",
# )
